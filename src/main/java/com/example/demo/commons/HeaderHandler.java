...
public class HeaderHandler implements IEventHandler {
    ...
    public HeaderHandler(Document doc) {
        this.doc = doc;
        TableRenderer renderer = (TableRenderer) tableHeader().createRendererSubTree();
    ...
    private Table tableHeader(){
        ...
        table.setWidth(523);
        table.addCell(new Cell(2, 0).add(new Paragraph("Factura"))
       ...
       return table.addCell(new Cell().add(new Paragraph("Nro: " + UUID.randomUUID().getMostSignificantBits()))
                .setTextAlignment(TextAlignment.RIGHT)
                .setBorder(Border.NO_BORDER));
    }
